...
public class ParadaTaxiVO {
	...
	public ParadaTaxiVO(int id, String title, Date fecha, float cor_x,
			float cor_y, String icon) {
	...
	public String toString() {
		return ("Estación servicio : [" + "id = " + this.id + ", "
				+ "título = " + this.title + ", " + ", fecha = " + this.fecha
